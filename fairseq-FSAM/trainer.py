...
class Trainer(object):
    ...
    def _build_optimizer(self):
        ...
        if (
            ...
            if self.cfg.optimizer.sam_type in ["fisher-esam","gsam","fisher-gsam", "fisher-sam"]:
                self._optimizer = optim.build_optimizer(self.cfg.optimizer, params, model=self.model)
            else:
